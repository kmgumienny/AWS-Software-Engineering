...
import main.controllers.DeleteOldSchedulesHandler;

public class TestDeleteOldSchedules
{
	
	static final int DAYS_PASSED = 1;
	
	@Test
	public void testDeleteOldSchedulesHandler() throws IOException
	{
		...
		input.addProperty("daysPassed", DAYS_PASSED);
